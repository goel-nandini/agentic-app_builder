...
export default function App() {
  const [items, setItems] = useState<Item[]>([
    { id: 1, title: "Initialize Core Application Architecture", category: "Task", status: "Done", priority: "High" },
    ...
    <div className="app-container">
      ...
      <header className="app-header">
        <div className="brand">
          ...
          <div>
            <h1>Interactive Kanban & Task Workspace</h1>
            <p>Drag-and-drop style column board with reactive task state</p>
          </div>
        </div>
