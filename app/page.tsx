        ...
        <div className="relative mx-auto mt-12 w-full max-w-2xl">
          ...
          >
            <textarea
              ...
              rows={1}
              className="w-full resize-none bg-transparent px-5 pb-4 pt-5 text-sm text-white placeholder:text-white/30 caret-white focus:outline-none sm:text-base selection:bg-white/20"
