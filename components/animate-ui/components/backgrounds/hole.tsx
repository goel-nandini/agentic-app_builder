...
function HoleBackground({
  ...
  const tick = React.useCallback(() => {
    ...
    moveDiscs();
    moveParticles();
    // Horizontal & vertical lines removed for a clean background
    drawParticles(ctx);
    ctx.restore();
    animationFrameIdRef.current = requestAnimationFrame(tick);
  }, [moveDiscs, moveParticles, drawParticles]);
  ...
  return (
    <div
      ...
      className={cn(
        'relative size-full overflow-hidden backdrop-blur-md',
        'before:content-[""] before:absolute before:top-1/2 before:left-1/2 before:block before:size-[140%] dark:before:[background:radial-gradient(ellipse_at_50%_55%,transparent_15%,rgba(20,20,35,0.7)_65%)] before:[background:radial-gradient(ellipse_at_50%_55%,transparent_15%,rgba(240,240,255,0.7)_65%)] before:[transform:translate3d(-50%,-50%,0)]',
        'after:content-[""] after:absolute after:z-[5] after:top-1/2 after:left-1/2 after:block after:size-full after:[background:radial-gradient(ellipse_at_50%_75%,rgba(168,85,247,0.25)_20%,transparent_75%)] after:[transform:translate3d(-50%,-50%,0)] after:mix-blend-screen',
        className,
      )}
      {...props}
    >
      ...
      <canvas
        ref={canvasRef}
        className="absolute inset-0 block size-full dark:opacity-30 opacity-20 blur-[2px]"
      />
      <motion.div
        className={cn(
          'absolute top-[-71.5%] left-1/2 z-[3] w-[40%] h-[140%] rounded-b-full blur-[100px] opacity-60 dark:mix-blend-plus-lighter mix-blend-plus-darker [transform:translate3d(-50%,0,0)] [background-position:0%_100%] [background-size:100%_200%]',
          'dark:[background:linear-gradient(20deg,#38bdf8,#a855f720_16.5%,#ec4899_33%,#ec489920_49.5%,#38bdf8_66%,#38bdf860_85.5%,#a855f7_100%)_0_100%_/_100%_200%] [background:linear-gradient(20deg,#38bdf8,#a855f740_16.5%,#ec4899_33%,#ec489940_49.5%,#38bdf8_66%,#38bdf880_85.5%,#a855f7_100%)_0_100%_/_100%_200%]',
        )}
