      ...
      <div className="border-t border-white/6 p-3">
        ...
        >
          <textarea
            ...
            rows={1}
            className="w-full resize-none bg-transparent px-3.5 pb-2 pt-3 text-[13px] text-white placeholder:text-white/30 caret-white focus:outline-none selection:bg-white/20"
            style={{ maxHeight: 160 }}
          />
